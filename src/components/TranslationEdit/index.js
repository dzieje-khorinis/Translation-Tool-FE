...
function TranslationEdit({user, dataLanguage, translationData, closeEditModal, editCallback}) {
    ...
    return (
        <section className="translation-editor" onClick={e => closeEditModal()}>
            <div className={"translation-wrapper " + (historyViewOpen ? "history-view" : "edit-view")} onClick={e => e.stopPropagation()}>
                <span onClick={e => closeEditModal()} className="link close_modal"><img title={t('Close')} src={closeIcon}/></span>

                {
                    historyViewOpen ?
                    <>
                        <span onClick={e => setHistoryViewOpen(false)} className="link back_to_edit_view"><img title={t('Back')} src={editIcon}/></span>
                        <TranslationHistory
                    ...
                    :
                    <>
                        <span onClick={e => setHistoryViewOpen(true)} className="link history_view"><img title={t('History')} src={historyIcon}/></span>
