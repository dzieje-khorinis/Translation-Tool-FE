...
function GlobalTranslationHistory({tableRef, dataLanguage, translationId}) {
    ...
    const ExampleCustomInput = forwardRef(({ value, onClick }, ref) => (
        <input className="custom_input" type="text" onClick={onClick} ref={ref} value={value} onChange={e => {}}/>          
    ));
    ...
    return (
       <div className="translation-history-wrapper">
        ...
        <div className="translation-history-filters">
            ...
            <div class="input_wrapper" style={{zIndex: 11}}>
                ...
                <Select
                    ...
                    isRtl={false}
                    isSearchable={false}
                    onChange={(option, {action}) => updateFilters({language: option?.value})}
                    placeholder=""
                    options={
            ...
            <div class="input_wrapper">
                ...
                <label for="id_search">{t('USERNAME')}</label>
                <input className="custom_input" type="text" value={usernameTemp} onChange={(e) => setUsernameTemp(e.target.value)}/>
            ...
            <div class="input_wrapper">
                ...
                <label for="id_search">{t('KEY')}</label>
                <input className="custom_input" type="text" value={keyTemp} onChange={(e) => setKeyTemp(e.target.value)}/>
